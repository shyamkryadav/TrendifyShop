...
const SignupForm = () => {
  ...
  return (
    ...
    <div className="form-group">
      ...
      />
      {formik?.errors.price && <div className="error-message">{formik.errors.price}</div>}
    </div>
    ...
    <div className="form-group">
      ...
      />
      {formik?.errors.stock && <div className="error-message">{formik.errors.stock}</div>}
    </div>
    ...
    <div className="form-group">
      ...
      />
      {formik?.errors.category && <div className="error-message">{formik.errors.category}</div>}
    </div>
